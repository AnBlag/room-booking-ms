...
public interface RecordTableFeignClient {
    ...
    RecordTableDTO saveRecord(@RequestBody RecordTableDTO recordTableDTO, @PathVariable String login);

    @RequestMapping(consumes = APPLICATION_JSON_VALUE,
            method = PUT,
            value = "/update/{login}",
            produces = APPLICATION_JSON_VALUE)
    RecordTableDTO updateRecord(@RequestBody RecordTableDTO recordTableDTO, @PathVariable String login);

    @RequestMapping(consumes = APPLICATION_JSON_VALUE,
            method = DELETE,
            value = "/delete/{login}",
            produces = APPLICATION_JSON_VALUE)
    RecordTableDTO deleteRecord(@RequestBody RecordTableDTO recordTableDTO, @PathVariable String login);
}